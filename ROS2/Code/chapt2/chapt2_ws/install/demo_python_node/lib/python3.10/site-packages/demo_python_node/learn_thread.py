...
def main():
    download = Download()
    download.start_download('http://0.0.0.0:8000/nocel1.txt',world_count)
    download.start_download('http://0.0.0.0:8000/nocel2.txt',world_count)
    download.start_download('http://0.0.0.0:8000/nocel3.txt',world_count)
