...
class Init_FaceDetector_Response_num
{
public:
  Init_FaceDetector_Response_num()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_FaceDetector_Response_use_time num(::chapt4_interfaces::srv::FaceDetector_Response::_num_type arg)
  {
...
{
  return chapt4_interfaces::srv::builder::Init_FaceDetector_Response_num();
}
